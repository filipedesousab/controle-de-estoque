...
CREATE TABLE `tb_pessoa` (
  ...
  `pes_perfil_cliente` char(1) NOT NULL,
  `pes_perfil_vendedor` char(1) NOT NULL,
  `pes_perfil_fornecedor` char(1) NOT NULL,
  `pes_documento` varchar(20) NOT NULL,
  `pes_tipo_documento` varchar(20) NOT NULL,
  `pes_email` varchar(70) NOT NULL,
  `pes_ddd` char(2) NOT NULL,
  `pes_telefone` varchar(10) NOT NULL,
...
CREATE TABLE `tb_produto` (
  ...
  `pro_quantidade_estoque` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `tb_produto_venda` (
  ...
  `pro_id` int(11) NOT NULL,
  `pv_quantidade` int(11) NOT NULL,
  `pv_valor` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `tb_pessoa`
  ...
  ADD UNIQUE KEY `unq_tb_pessoa_email` (`pes_email`),
...
ALTER TABLE `tb_produto`
  ...
  ADD KEY `ind_tb_produto_pes_id` (`pes_id`);

--
-- Indexes for table `tb_produto_venda`
--
ALTER TABLE `tb_produto_venda`
  ADD PRIMARY KEY (`pv_id`),
  ADD KEY `ind_tb_porduto_venda_ven_id` (`ven_id`),
  ADD KEY `ind_tb_porduto_venda_pro_id` (`pro_id`);
...
ALTER TABLE `tb_venda`
  ...
  ADD KEY `ind_tb_venda_pes_id` (`pes_id`);
...
--
-- AUTO_INCREMENT for table `tb_produto_venda`
--
ALTER TABLE `tb_produto_venda`
...
--
ALTER TABLE `tb_pessoa`
  ADD CONSTRAINT `FK_TB_PESSOA_MUN_ID` FOREIGN KEY (`mun_id`) REFERENCES `tb_municipio` (`mun_id`);

--
-- Limitadores para a tabela `tb_produto`
--
ALTER TABLE `tb_produto`
  ADD CONSTRAINT `FK_TB_PRODUTO_PES_ID` FOREIGN KEY (`pes_id`) REFERENCES `tb_pessoa` (`pes_id`);

--
-- Limitadores para a tabela `tb_produto_venda`
--
ALTER TABLE `tb_produto_venda`
  ADD CONSTRAINT `FK_TB_PRODUTO_VENDA_PRO_ID` FOREIGN KEY (`pro_id`) REFERENCES `tb_produto` (`pro_id`),
  ADD CONSTRAINT `FK_TB_PRODUTO_VENDA_VEN_ID` FOREIGN KEY (`ven_id`) REFERENCES `tb_venda` (`ven_id`);
